...
// Calculo direccion de inicio del primer cuadrado (x,y) = (16,16)
    ...
    mov x12, 120 // Lo que le tengo que sumar al framebuffer cada vez que termino un cuadrado de una fila  
...
dibujarCuadrados:
    ...
    mov x7, 8 // Nueva fila vuelvo a empezar el contador

    cmp x8, 9   // Si el contador de cantidad de filas es 8, salteo la instruccion de sumarle 64
    beq cont1   // es decir, de bajar una fila. Si no es 8, le sumo 64 a la direccion de inicio y voy a bajar una fila

    mov x12, 60600   // Cantidad de pixeles por cuadrado
    add x13, x13, x12
    mov x12, 120
